  ...
  <div class="row calendar_section" id="nursing_calendar_listing">
    <div class="row">
      ...
      <div class="col-sm-2 text-left">
        <a href="<?php echo home_url('/'); ?>add-group" class="btn btn-primary stretched-link">Add New</a>
      </div>
    </div>
    <div class="col-sm-12 request-table">
     <div class="row accepted_color">
       <div class="col-sm-10">
        <p class="calendar-request">My Groups List</p>
      </div>
    </div>
    <div class="row">
      <?php
                ...
                if(!empty($groups)):
                  ...
                  foreach($groups as $group):
                    ...
                    <tr>
                      ...
                      <td width="200px"><?php echo $group->group_name; ?></td>

                      <td><a href="<?php echo home_url('/').'add-group/?group-id='.$group->id; ?>">Edit</a> / <a href="#" data-del_id="<?php echo $group->id; ?>" Style="color:red;" class="delete-role">Delete</a></td>
                    </tr>
                    <?php
                    $counter++;
                  endforeach;
