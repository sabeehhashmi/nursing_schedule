  ...
  <div class="row calendar_section" id="nursing_calendar_listing">
    <div class="row">
      ...
      <div class="col-sm-2 text-left">
        <a href="<?php echo home_url('/'); ?>add-role" class="btn btn-primary stretched-link">Add New</a>
      </div>
    </div>
    <div class="col-sm-12 request-table">
     <div class="row accepted_color">
       <div class="col-sm-10">
        <p class="calendar-request">Manage Roles</p>
      </div>
    </div>
    <div class="row">
      <?php
                ...
                if(!empty($roles)):
                  ...
                  foreach($roles as $role):
                    ...
                    <tr>
                      ...
                      <td width="200px"><?php echo $role->role_name; ?></td>

                      <td><a href="<?php echo home_url('/').'add-role/?role-id='.$role->id; ?>">Edit</a> / <a href="#" data-del_id="<?php echo $role->id; ?>" Style="color:red;" class="delete-role">Delete</a></td>
                    </tr>
                    <?php
                    $counter++;
                  endforeach;
  ...
  jQuery(document).ready(function($){
    ...
    $( ".delete-role" ).click(function(e) {
      ...
      jQuery.ajax({
       ...
       dataType : "json",
       url : myAjax.ajaxurl,
       data: {action:'delete_role',user_id:user_id},
